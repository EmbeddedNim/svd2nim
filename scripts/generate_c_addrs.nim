...
iterator allRegistersFq(periph: SvdPeripheral):
  tuple[fqname: string, reg: SvdRegister] =
...
proc main() =
  ...
  outf.writeLine(&"# Register addresses according to SVDConv output for SVD file '{svdFile.extractFileName}'")
  outf.writeLine("")
