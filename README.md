...
resulting numerical to the appropriate enum type will succeed. The numerical
value may be invalid for the enum type: a 4-bit bitfield may read `11` when
only values `0` through `10` are defined in the enum type.
